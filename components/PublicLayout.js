                                                    ...
                                                    <div className="h-full flex justify-center space-x-8">
                                                        {menuCategories?.map((category, idx) => category.menu && (
                                                            ...
                                                            <Link key={idx} href={slugCategory(category)}>
                                                                <a className="relative z-10 hover:opacity-80 flex items-center justify-center transition-colors ease-out duration-200 text-sm font-medium text-white">{category.name}</a>
                                                            </Link>
