...
export default function Account({sett}) {
    ...
    return (
        <PublicLayout sett={sett} title={t('seo-index-title')} description={t('seo-index-description')}>
                        ...
                        <section aria-labelledby="plan-heading">
                          ...
                          />
                                            ...
                                            <Switch.Label as="span" className="ml-3">
                                                <span
                                                    className="text-sm font-medium text-gray-900">Annual billing </span>
