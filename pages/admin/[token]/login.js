...
import AdminGuestServerSideProps from "../../../lib/props/AdminGuestServerSideProps";

// This gets called on every request
export const getServerSideProps = AdminGuestServerSideProps
...
export default function AdminLogin() {
    ...
    const AuthPost = (evt) => {
        ...
        // TODO: make auth
        axios
            .post(`/api/${window.location.pathname}`, credentials)
