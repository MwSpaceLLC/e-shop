                                        ...
                                        <div className="flex-1 pt-2 flex items-end justify-between">
                                            ...
                                            <div className="ml-4">
                                                ...
                                                <select
                                                    id="quantity"
                                                    name="quantity"
                                                    className="rounded-md border border-gray-300 text-base font-medium text-gray-700 text-left shadow-sm focus:outline-none focus:ring-1 focus:ring-shop focus:border-shop sm:text-sm"
                                                >
