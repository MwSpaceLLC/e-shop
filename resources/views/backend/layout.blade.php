...
<div id="main-wrapper">
    @include('eshop::backend.components.header')

    @include('eshop::backend.components.sidebar')

    @include('eshop::backend.components.breadcrumb')

    @yield('content')

    @include('eshop::backend.components.footer')
</div>
