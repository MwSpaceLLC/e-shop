                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" data-tippy-content="day, week, month or year">

                                                    <select class="js-states form-control"

                                                            data-placeholder="@lang('eshop::model.'. $m . 'Interval')"
                                                            tabindex="-1"
                                                            data-minimum-results-for-search="Infinity"
                                                            name="payload[interval]" style="display: none; width: 100%">
